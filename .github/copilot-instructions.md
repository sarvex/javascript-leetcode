...
- always create a tagline at the top of JSDoc comments telling the approach of the solution
- describe the @intuition i.e. "first thoughts on how to solve this problem" in the JSDoc comments as second section
- describe the @approach i.e. "your approach to solving the problem" in the JSDoc comments as third section
- include @complexity in the JSDoc comments, separate lines for time and space, as forth section
